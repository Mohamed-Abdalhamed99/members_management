...
class PermissionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
       // Permission::create(['name' => '', 'display_name' => 'Home', 'guard_name' => 'admin', 'icon' => 'fas fa-user', 'appear' => '1', 'ordering' => '1']);
        ...
        //Roles
        Permission::create(['name' => 'roles.index'       , 'display_name_en' => 'Roles'        , 'display_name_ar' => 'الأدوار'         ,'guard_name' => 'api', 'route' => 'roles' ,'icon' => 'fas fa-user', 'appear' => '1', 'ordering' => '1']);
        ...
        //plans
        Permission::create(['name' => 'plans.index'       , 'display_name_en' => 'Plans'        , 'display_name_ar' => 'الخطط' ,'guard_name' => 'api',             'route' => 'plans' , 'icon' => 'fas fa-user', 'appear' => '1', 'ordering' => '1']);
        ...
        //plans
        Permission::create(['name' => 'users.index'       , 'display_name_en' => 'users'        , 'display_name_ar' => 'المستخدمين' ,'guard_name' => 'api',             'route' => 'users' ,'icon' => 'fas fa-user', 'appear' => '1', 'ordering' => '1']);
